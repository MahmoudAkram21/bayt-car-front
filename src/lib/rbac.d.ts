...
export type PermissionModuleKey = 'DASHBOARD' | 'USERS' | 'SYSTEM_USERS' | 'PROVIDERS' | 'SERVICES' | 'SERVICE_REQUESTS' | 'SUPPORT_TICKETS' | 'COMMISSIONS' | 'WALLETS' | 'INVOICES' | 'REPORTS' | 'LOYALTY' | 'PROMOS' | 'COMMISSION_RULES' | 'TAX' | 'BANNERS' | 'SPLASH' | 'SETTINGS' | 'ORDERS' | 'NOTIFICATIONS';
