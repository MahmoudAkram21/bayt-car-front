...
import { splashService, type SplashScreen } from '../../services/splash.service';
    ...
    <div className="animate-fade-in">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="mt-2 max-w-2xl text-base text-gray-600 dark:text-gray-400">
          Mobile app splash screens. Image, title, description, action. Platform and date range.
        </p>
      </div>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2">
        <div className="overflow-hidden rounded-2xl border border-cyan-200 bg-cyan-50 shadow-sm dark:border-cyan-800 dark:bg-cyan-900/20">
          <div className="flex items-center justify-between p-5">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Total splash</p>
      ...
      <Card className="overflow-hidden rounded-2xl border-gray-200 shadow-lg dark:border-gray-700 dark:bg-gray-800">
        <CardHeader>
          ...
          <CardDescription>Image, title, platform, valid range</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading && (
          ...
          {error && (
            <div className="rounded-xl border border-red-200 bg-red-50 py-8 text-center text-red-600 dark:border-red-800 dark:bg-red-900/20 dark:text-red-400">
              Failed to load splash screens.
            </div>
          )}
          {!isLoading && !error && list.length === 0 && (
            <div className="py-12 text-center text-gray-500 dark:text-gray-400">No splash screens yet.</div>
          )}
