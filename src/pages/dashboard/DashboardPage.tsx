...
import { Users, Building2, Calendar, DollarSign, TrendingUp, PieChart } from 'lucide-react';
import {
  BarChart,
  Bar,
  XAxis,
        ...
        {statCards.map((card, i) => (
          <div
            ...
            className={`
              ...
              ${card.border} ${card.bg}
              ${i === 0 ? '' : i === 1 ? 'animate-card-enter-delay-1' : i === 2 ? 'animate-card-enter-delay-2' : i === 3 ? 'animate-card-enter-delay-3' : 'animate-card-enter-delay-4'}
            `}
          >
            <div className="p-5">
      ...
      <div className="animate-chart-enter mt-8 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">
        <div className="p-6">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Use the sidebar to manage users, providers, services, bookings, and commissions.
            Data and charts above update from your API.
          </p>
        </div>
      </div>
    </div>
